...
public enum EnumConnectionState
{
    ...
    private static int MIN_STATE_ID = -1;
    private static int MAX_STATE_ID = 2;
    public static final EnumConnectionState[] VALUES = values();
    private static final EnumConnectionState[] STATES_BY_ID = new EnumConnectionState[MAX_STATE_ID - MIN_STATE_ID + 1];
    ...
    {
        this.directionMaps = Maps.<EnumPacketDirection, BiMap<Integer, Class<? extends Packet>>>newEnumMap(EnumPacketDirection.class);
        this.id = protocolId;
    }
    ...
    {
        return stateId >= MIN_STATE_ID && stateId <= MAX_STATE_ID ? STATES_BY_ID[stateId - MIN_STATE_ID] : null;
    }
    ...
    static {
        for (EnumConnectionState enumconnectionstate : VALUES)
        {
            ...
            if (i < MIN_STATE_ID || i > MAX_STATE_ID)
            {
                throw new Error("Invalid protocol ID " + Integer.toString(i));
            }

            STATES_BY_ID[i - MIN_STATE_ID] = enumconnectionstate;
