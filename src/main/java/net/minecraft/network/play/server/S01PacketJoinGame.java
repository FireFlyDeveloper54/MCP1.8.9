...
public class S01PacketJoinGame implements Packet<INetHandlerPlayClient>
{
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        int gameModeFlags = buf.readUnsignedByte();
        this.hardcoreMode = (gameModeFlags & 8) == 8;
        gameModeFlags = gameModeFlags & -9;
        this.gameType = WorldSettings.GameType.getByID(gameModeFlags);
    ...
    public void writePacketData(PacketBuffer buf) throws IOException
    {
        ...
        int gameModeFlags = this.gameType.getID();
