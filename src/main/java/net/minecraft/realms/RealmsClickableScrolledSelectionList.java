...
public class RealmsClickableScrolledSelectionList
{
    ...
    public RealmsClickableScrolledSelectionList(int width, int height, int top, int bottom, int slotHeight)
    {
        this.proxy = new GuiClickableScrolledSelectionListProxy(this, width, height, top, bottom, slotHeight);
    }
    ...
    public void customMouseEvent(int top, int bottom, int headerPadding, float scrollAmount, int slotHeight)
    {
    }
    ...
    public void itemClicked(int cursorX, int cursorY, int mouseButton, int relativeX, int relativeY)
    {
    }

    public void renderSelected(int width, int y, int height, Tezzelator tezzelator)
    {
    }

    public void setLeftPos(int leftPos)
    {
        this.proxy.setSlotXBoundsFromLeft(leftPos);
    }
}
