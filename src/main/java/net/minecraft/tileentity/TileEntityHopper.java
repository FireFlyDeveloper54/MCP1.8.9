...
public class TileEntityHopper extends TileEntityLockable implements IHopper, ITickable
{
    ...
    public static boolean putDropInInventoryAllSlots(IInventory inventory, EntityItem itemIn)
    {
        boolean flag = false;
        ...
        else
        {
            ...
            ItemStack itemstack1 = putStackInInventoryAllSlots(inventory, itemStack, (EnumFacing)null);
    ...
    {
        return worldIn.<EntityItem>getEntitiesWithinAABB(EntityItem.class, new AxisAlignedBB(x - 0.5D, y - 0.5D, z - 0.5D, x + 0.5D, y + 0.5D, z + 0.5D), EntitySelectors.selectAnything);
    }
