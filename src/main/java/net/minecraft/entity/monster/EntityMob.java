...
public abstract class EntityMob extends EntityCreature implements IMob
{
    ...
    {
        BlockPos.MutableBlockPos blockpos = this.lightCheckPos.set(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.getEntityBoundingBox().minY), MathHelper.floor_double(this.posZ));
