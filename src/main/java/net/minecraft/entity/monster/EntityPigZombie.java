...
public class EntityPigZombie extends EntityZombie
{
    ...
    {
        public AIHurtByAggressor(EntityPigZombie pigZombieIn)
        {
            super(pigZombieIn, true, new Class[0]);
        }
    ...
    {
        public AITargetAggressor(EntityPigZombie pigZombieIn)
        {
            super(pigZombieIn, EntityPlayer.class, true);
        }
