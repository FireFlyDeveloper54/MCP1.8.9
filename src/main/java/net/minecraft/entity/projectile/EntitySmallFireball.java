...
public class EntitySmallFireball extends EntityFireball
{
    ...
    protected void onImpact(MovingObjectPosition movingObject)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            {
                boolean hitConfirmed = movingObject.entityHit.attackEntityFrom(DamageSource.causeFireballDamage(this, this.shootingEntity), 5.0F);
            ...
            {
                boolean canPlaceFire = true;

                if (this.shootingEntity != null && this.shootingEntity instanceof EntityLiving)
                {
                    canPlaceFire = this.worldObj.getGameRules().getBoolean("mobGriefing");
                }
