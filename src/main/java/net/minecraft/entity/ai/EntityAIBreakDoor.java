...
public class EntityAIBreakDoor extends EntityAIDoorInteract
{
    ...
    public boolean shouldExecute()
    {
        ...
        {
            BlockDoor currentDoorBlock = this.doorBlock;
    ...
    {
        double distanceToDoorSq = this.theEntity.getDistanceSq(this.doorPosition);
        boolean canContinue;
        ...
        if (this.breakingTime <= 240)
        {
            ...
            if (!BlockDoor.isOpen(this.theEntity.worldObj, this.doorPosition) && distanceToDoorSq < 4.0D)
            {
                canContinue = true;
                return canContinue;
            }
    ...
    public void updateTask()
    {
        ...
        ++this.breakingTime;
        int breakProgress = (int)((float)this.breakingTime / 240.0F * 10.0F);

        if (breakProgress != this.previousBreakProgress)
        {
            this.theEntity.worldObj.sendBlockBreakProgress(this.theEntity.getEntityId(), this.doorPosition, breakProgress);
            this.previousBreakProgress = breakProgress;
        }
