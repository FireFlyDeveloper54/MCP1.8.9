...
public class EntityAIFollowParent extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            for (EntityAnimal entityanimal1 : list)
            {
                ...
                {
                    double parentDistanceSq = this.childAnimal.getDistanceSqToEntity(entityanimal1);
            ...
            else if (closestDistanceSq < 9.0D)
            {
                return false;
            }
            else
    ...
    public boolean continueExecuting()
    {
        ...
        {
            double parentDistanceSq = this.childAnimal.getDistanceSqToEntity(this.parentAnimal);
            return parentDistanceSq >= 9.0D && parentDistanceSq <= 256.0D;
        }
    }
