...
public class EntityAIRunAroundLikeCrazy extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        {
            Vec3 runTarget = RandomPositionGenerator.findRandomTarget(this.horseHost, 5, 4);
            ...
            {
                this.targetX = runTarget.xCoord;
                this.targetY = runTarget.yCoord;
                this.targetZ = runTarget.zCoord;
                return true;
            }
        }
        else
