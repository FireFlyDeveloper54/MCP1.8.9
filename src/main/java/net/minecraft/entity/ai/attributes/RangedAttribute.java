...
public class RangedAttribute extends BaseAttribute
{
    ...
    public RangedAttribute(IAttribute parentAttribute, String unlocalizedNameIn, double defaultValue, double minimumValueIn, double maximumValueIn)
    {
        super(parentAttribute, unlocalizedNameIn, defaultValue);
