...
public class EntityAIMoveTowardsTarget extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        {
            Vec3 targetPos = RandomPositionGenerator.findRandomTargetBlockTowards(this.theEntity, 16, 7, new Vec3(this.targetEntity.posX, this.targetEntity.posY, this.targetEntity.posZ));
