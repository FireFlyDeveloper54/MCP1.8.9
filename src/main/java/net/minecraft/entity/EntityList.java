...
public class EntityList
{
    ...
    private static final Map < Class <? extends Entity > , String > classToTranslationKeyMapping = Maps. < Class <? extends Entity > , String > newHashMap();
    ...
    private static final ConcurrentMap<Class <? extends Entity>, Constructor <? extends Entity>> constructorCache = new ConcurrentHashMap<Class <? extends Entity>, Constructor <? extends Entity>>();
    ...
    private static Entity createEntity(Class <? extends Entity> entityClass, World worldIn) throws ReflectiveOperationException
    {
        Constructor <? extends Entity> constructor = constructorCache.get(entityClass);

        if (constructor == null)
        {
            Constructor <? extends Entity> resolved = entityClass.getConstructor(World.class);
            Constructor <? extends Entity> existing = constructorCache.putIfAbsent(entityClass, resolved);
            constructor = existing == null ? resolved : existing;
        }
    ...
    private static void addMapping(Class <? extends Entity > entityClass, String entityName, int id)
    {
        ...
        else
        {
            ...
            classToTranslationKeyMapping.put(entityClass, "entity." + entityName + ".name");
    ...
    public static Entity createEntityByName(String entityName, World worldIn)
    {
        ...
        try
        {
            ...
            if (oclass != null)
            {
                entity = createEntity(oclass, worldIn);
            }
        }
    ...
    public static String getEntityTranslationKey(Entity entityIn)
    {
        String translationKey = classToTranslationKeyMapping.get(entityIn.getClass());
        return translationKey == null ? "entity.generic.name" : translationKey;
    }
    ...
    public static void initEntityStats()
    {
    }
    ...
    public static class EntityEggInfo
    {
        ...
        public final StatBase killedByEntityStat;
        ...
        public EntityEggInfo(int id, int baseColor, int spotColor)
        {
            ...
            this.killedByEntityStat = StatList.getStatEntityKilledBy(this);
        }
    }
}
