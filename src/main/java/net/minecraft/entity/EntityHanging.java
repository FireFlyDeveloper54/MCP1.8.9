...
public abstract class EntityHanging extends Entity
{
    ...
    private void updateBoundingBox()
    {
        ...
        {
            double xCoordinate = (double)this.hangingPosition.getX() + 0.5D;
            double yCoordinate = (double)this.hangingPosition.getY() + 0.5D;
            double zCoordinate = (double)this.hangingPosition.getZ() + 0.5D;
            double doubleValue = 0.46875D;
            double doubleValue2 = this.getPixelOffset(this.getWidthPixels());
            double doubleValue3 = this.getPixelOffset(this.getHeightPixels());
            xCoordinate = xCoordinate - (double)this.facingDirection.getFrontOffsetX() * 0.46875D;
            zCoordinate = zCoordinate - (double)this.facingDirection.getFrontOffsetZ() * 0.46875D;
            yCoordinate = yCoordinate + doubleValue3;
            EnumFacing enumfacing = this.facingDirection.rotateYCCW();
            xCoordinate = xCoordinate + doubleValue2 * (double)enumfacing.getFrontOffsetX();
            zCoordinate = zCoordinate + doubleValue2 * (double)enumfacing.getFrontOffsetZ();
            this.posX = xCoordinate;
            this.posY = yCoordinate;
            this.posZ = zCoordinate;
            double doubleValue4 = (double)this.getWidthPixels();
            double doubleValue5 = (double)this.getHeightPixels();
            double doubleValue6 = (double)this.getWidthPixels();
            ...
            doubleValue4 = doubleValue4 / 32.0D;
            doubleValue5 = doubleValue5 / 32.0D;
            doubleValue6 = doubleValue6 / 32.0D;
            this.setEntityBoundingBox(new AxisAlignedBB(xCoordinate - doubleValue4, yCoordinate - doubleValue5, zCoordinate - doubleValue6, xCoordinate + doubleValue4, yCoordinate + doubleValue5, zCoordinate + doubleValue6));
        }
    }
