...
public abstract class EntityAnimal extends EntityAgeable implements IAnimals
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.inLove > 0)
        {
            ...
            if (this.inLove % 10 == 0)
            {
                ...
                this.worldObj.spawnParticle(EnumParticleTypes.HEART, this.posX + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, this.posY + 0.5D + (double)(this.rand.nextFloat() * this.height), this.posZ + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, doubleValue, doubleValue2, doubleValue3, EnumParticleTypes.EMPTY_ARGS);
            }
        }
    }
    ...
    public boolean getCanSpawnHere()
    {
        ...
        BlockPos.MutableBlockPos blockPos = this.spawnCheckPos.set(i, j, k);
    ...
    public boolean interact(EntityPlayer player)
    {
        ...
        if (itemStack != null)
        {
            ...
            {
                this.consumeItemFromStack(player, itemStack);
                this.addGrowth((int)((float)(-this.getGrowingAge() / 20) * 0.1F), true);
                return true;
            }
        }
