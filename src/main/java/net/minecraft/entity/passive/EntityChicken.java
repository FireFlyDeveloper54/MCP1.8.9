...
public class EntityChicken extends EntityAnimal
{
    ...
    public void onLivingUpdate()
    {
        ...
        this.wingRotationPrev = this.wingRotation;
    ...
    public void updateRiderPosition()
    {
        ...
        float yawCos = MathHelper.cos(this.renderYawOffset * (float)Math.PI / 180.0F);
        float riderOffset = 0.1F;
        float riderHeightOffset = 0.0F;
        this.riddenByEntity.setPosition(this.posX + (double)(riderOffset * f), this.posY + (double)(this.height * 0.5F) + this.riddenByEntity.getYOffset() + (double)riderHeightOffset, this.posZ - (double)(riderOffset * yawCos));
