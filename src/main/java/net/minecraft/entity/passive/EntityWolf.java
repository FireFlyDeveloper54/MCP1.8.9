...
public class EntityWolf extends EntityTameable
{
        ...
        else if ((this.isWet || this.isShaking) && this.isShaking)
        {
            ...
            if (this.timeWolfIsShaking > 0.4F)
            {
                ...
                for (int j = 0; j < i; ++j)
                {
                    ...
                    this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, this.posX + (double)offsetX, (double)(f + 0.8F), this.posZ + (double)offsetZ, this.motionX, this.motionY, this.motionZ, EnumParticleTypes.EMPTY_ARGS);
                }
            }
        }
    }
    ...
    public void setAngry(boolean angry)
    {
        ...
        {
            this.dataWatcher.updateObject(16, Byte.valueOf((byte)(byteValue & -3)));
        }
    }
