...
public class EntitySheep extends EntityAnimal
{
    ...
    {
        return this.sheepTimer <= 0 ? 0.0F : (this.sheepTimer >= 4 && this.sheepTimer <= 36 ? 1.0F : (this.sheepTimer < 4 ? ((float)this.sheepTimer - partialTicks) / 4.0F : -((float)(this.sheepTimer - 40) - partialTicks) / 4.0F));
    }
    ...
    public float getHeadRotationAngleX(float partialTicks)
    {
        ...
        {
            float f = ((float)(this.sheepTimer - 4) - partialTicks) / 32.0F;
    ...
    public void setFleeceColor(EnumDyeColor color)
    {
        ...
        this.dataWatcher.updateObject(16, Byte.valueOf((byte)(byteValue & 240 | color.getMetadata() & 15)));
    }
    ...
    public void setSheared(boolean sheared)
    {
        ...
        if (sheared)
        {
            this.dataWatcher.updateObject(16, Byte.valueOf((byte)(byteValue | 16)));
        }
        else
        {
            this.dataWatcher.updateObject(16, Byte.valueOf((byte)(byteValue & -17)));
        }
    }
