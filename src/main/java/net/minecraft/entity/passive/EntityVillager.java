...
public class EntityVillager extends EntityAgeable implements IMerchant, INpc
{
        ...
        else
        {
            ...
            switch (this.getProfession())
            {
                case 0:
                    ...
                    {
                        stringValue = "fisherman";
                    }
                    else if (this.careerId == 3)
                    {
                        stringValue = "shepherd";
                    }
                    else if (this.careerId == 4)
                    {
                        stringValue = "fletcher";
                    }

                    break;

                case 1:
                    stringValue = "librarian";
                    break;
            ...
            if (stringValue != null)
            {
                ChatComponentTranslation chatComponentTranslation = new ChatComponentTranslation("entity.Villager." + stringValue, new Object[0]);
    ...
    private void spawnParticles(EnumParticleTypes particleType)
    {
        for (int i = 0; i < 5; ++i)
        {
            ...
            this.worldObj.spawnParticle(particleType, this.posX + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, this.posY + 1.0D + (double)(this.rand.nextFloat() * this.height), this.posZ + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, doubleValue, doubleValue2, doubleValue3, EnumParticleTypes.EMPTY_ARGS);
        }
    }
    ...
    static class ItemAndEmeraldToItem implements EntityVillager.ITradeList
    {
        ...
        public ItemAndEmeraldToItem(Item buyingItem, EntityVillager.PriceInfo buyingPriceInfoIn, Item sellingItem, EntityVillager.PriceInfo sellingPriceInfoIn)
        {
            this.buyingItemStack = new ItemStack(buyingItem);
            this.buyingPriceInfo = buyingPriceInfoIn;
            this.sellingItemstack = new ItemStack(sellingItem);
            this.sellingPriceInfo = sellingPriceInfoIn;
        }
    ...
    static class ListEnchantedItemForEmeralds implements EntityVillager.ITradeList
    {
        ...
        public ListEnchantedItemForEmeralds(Item enchantedItem, EntityVillager.PriceInfo priceInfoIn)
        {
            this.enchantedItemStack = new ItemStack(enchantedItem);
    ...
    static class ListItemForEmeralds implements EntityVillager.ITradeList
    {
        ...
        public ListItemForEmeralds(Item item, EntityVillager.PriceInfo priceInfo)
        {
