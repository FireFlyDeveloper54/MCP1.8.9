...
public class EntitySquid extends EntityWaterMob
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.inWater)
        {
            ...
            this.squidPitch += (-((float)MathHelper.atan2((double)floatValue, this.motionY)) * 180.0F / (float)Math.PI - this.squidPitch) * 0.1F;
        }
        else
        {
    ...
    static class AIMoveRandom extends EntityAIBase
    {
        ...
        public AIMoveRandom(EntitySquid squidIn)
        {
            this.squid = squidIn;
        }
        ...
        public void updateTask()
        {
            ...
            else if (this.squid.getRNG().nextInt(50) == 0 || !this.squid.inWater || !this.squid.hasMovementVector())
            {
                ...
                float floatValue2 = MathHelper.cos(f) * 0.2F;
                float floatValue3 = -0.1F + this.squid.getRNG().nextFloat() * 0.2F;
                float floatValue4 = MathHelper.sin(f) * 0.2F;
                this.squid.setMovementVector(floatValue2, floatValue3, floatValue4);
            }
        }
    }
}
