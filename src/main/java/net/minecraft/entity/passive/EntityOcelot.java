...
{
    private final BlockPos.MutableBlockPos collisionSamplePos = new BlockPos.MutableBlockPos();
    ...
    public void updateAITasks()
    {
        ...
        {
            double movementSpeed = this.getMoveHelper().getSpeed();

            if (movementSpeed == 0.6D)
            {
                this.setSneaking(true);
                this.setSprinting(false);
            }
            else if (movementSpeed == 1.33D)
            {
    ...
    public boolean isNotColliding()
    {
        ...
        {
            BlockPos.MutableBlockPos blockPos = this.collisionSamplePos.set(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.getEntityBoundingBox().minY), MathHelper.floor_double(this.posZ));
