    ...
    private void populateEnvironment()
    {
        ...
        this.theReportCategory.addCrashSectionCallable("Memory", new Callable<String>()
        {
            public String call()
            {
                ...
                long longValue5 = j / 1024L / 1024L;
                long longValue6 = k / 1024L / 1024L;
                return k + " bytes (" + longValue6 + " MB) / " + j + " bytes (" + longValue5 + " MB) up to " + i + " bytes (" + l + " MB)";
            }
        });
        this.theReportCategory.addCrashSectionCallable("JVM Flags", new Callable<String>()
        {
            public String call()
            {
                ...
                return i + " total; " + stringBuilder.toString();
            }
        });
