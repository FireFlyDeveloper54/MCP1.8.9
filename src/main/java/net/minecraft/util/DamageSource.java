...
public class DamageSource
{
    ...
    public IChatComponent getDeathMessage(EntityLivingBase entityLivingBaseIn)
    {
        ...
        String playerTranslationKey = translationKey + ".player";
        return attacker != null && StatCollector.canTranslate(playerTranslationKey) ? new ChatComponentTranslation(playerTranslationKey, new Object[] {entityLivingBaseIn.getDisplayName(), attacker.getDisplayName()}): new ChatComponentTranslation(translationKey, new Object[] {entityLivingBaseIn.getDisplayName()});
    }
