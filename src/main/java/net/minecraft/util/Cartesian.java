...
public class Cartesian
{
    ...
    {
        return (T[])((Object[])((Object[])Array.newInstance(clazz, length)));
    }
    ...
    static class GetList<T> implements Function<Object[], List<T>>
    {
        ...
        public List<T> apply(Object[] values)
        {
    ...
    static class Product<T> implements Iterable<T[]>
    {
        ...
        {
            return this.iterables.length <= 0 ? Collections.<T[]>singletonList(Cartesian.<T>createArray(this.clazz, 0)).iterator() : new Cartesian.Product.ProductIterator(this.clazz, this.iterables);
        }
        ...
        static class ProductIterator<T> extends UnmodifiableIterator<T[]>
        {
            ...
            private ProductIterator(Class<T> clazz, Iterable <? extends T > [] iterables)
            {
                ...
                for (int iterableIndex = 0; iterableIndex < this.iterables.length; ++iterableIndex)
                {
                    this.iterators[iterableIndex] = iterables[iterableIndex].iterator();
                }
