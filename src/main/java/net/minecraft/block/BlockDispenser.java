...
public class BlockDispenser extends BlockContainer
{
    ...
    public static IPosition getDispensePosition(IBlockSource coords)
    {
        ...
        double xCoordinate = coords.getX() + 0.7D * (double)enumfacing.getFrontOffsetX();
        double yCoordinate = coords.getY() + 0.7D * (double)enumfacing.getFrontOffsetY();
        double zCoordinate = coords.getZ() + 0.7D * (double)enumfacing.getFrontOffsetZ();
        return new PositionImpl(xCoordinate, yCoordinate, zCoordinate);
    }
