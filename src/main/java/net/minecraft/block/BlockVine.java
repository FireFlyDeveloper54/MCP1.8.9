...
public class BlockVine extends Block
{
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        {
            floatValue5 = Math.max(floatValue5, 0.0625F);
            floatValue2 = 0.0F;
            floatValue3 = 0.0F;
            floatValue6 = 1.0F;
            floatValue4 = 0.0F;
        ...
        {
            floatValue2 = Math.min(floatValue2, 0.9375F);
            floatValue5 = 1.0F;
            floatValue3 = 0.0F;
            floatValue6 = 1.0F;
            floatValue4 = 0.0F;
        ...
        {
            floatValue7 = Math.max(floatValue7, 0.0625F);
            floatValue4 = 0.0F;
            floatValue2 = 0.0F;
            floatValue5 = 1.0F;
            floatValue3 = 0.0F;
        ...
        {
            floatValue4 = Math.min(floatValue4, 0.9375F);
            floatValue7 = 1.0F;
            floatValue2 = 0.0F;
            floatValue5 = 1.0F;
            floatValue3 = 0.0F;
        ...
        {
            floatValue3 = Math.min(floatValue3, 0.9375F);
            floatValue6 = 1.0F;
            floatValue2 = 0.0F;
            floatValue5 = 1.0F;
            floatValue4 = 0.0F;
        ...
        this.setBlockBounds(floatValue2, floatValue3, floatValue4, floatValue5, floatValue6, floatValue7);
    }
            ...
            if (worldIn.rand.nextInt(4) == 0)
            {
                ...
                for (int k = -i; k <= i; ++k)
                {
                    for (int l = -i; l <= i; ++l)
                    {
                        ...
                        {
                            if (worldIn.getBlockState(pos.add(k, index, l)).getBlock() == this)
                            {
                                --j;
