        ...
        if (!worldIn.isRemote)
        {
            ...
            if (tileEntity instanceof BlockJukebox.TileEntityJukebox)
            {
                ...
                if (itemStack != null)
                {
                    ...
                    double doubleValue2 = (double)(worldIn.rand.nextFloat() * f) + (double)(1.0F - f) * 0.2D + 0.6D;
                    double doubleValue3 = (double)(worldIn.rand.nextFloat() * f) + (double)(1.0F - f) * 0.5D;
                    ItemStack itemstack1 = itemStack.copy();
                    EntityItem entityItem = new EntityItem(worldIn, (double)pos.getX() + doubleValue, (double)pos.getY() + doubleValue2, (double)pos.getZ() + doubleValue3, itemstack1);
