...
public class BlockWall extends Block
{
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        float f = 0.25F;
        float floatValue2 = 0.75F;
        float floatValue3 = 0.25F;
        float floatValue4 = 0.75F;
        float floatValue5 = 1.0F;
        ...
        this.setBlockBounds(f, 0.0F, floatValue3, floatValue2, floatValue5, floatValue4);
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        public static final BlockWall.EnumType[] VALUES = values();
