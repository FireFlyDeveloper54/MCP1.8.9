...
public class BlockDirt extends Block
{
    ...
    public static enum DirtType implements IStringSerializable
    {
        ...
        public static final BlockDirt.DirtType[] VALUES = values();
        ...
        private DirtType(int metadata, String name, MapColor mapColor)
        {
            this(metadata, name, name, mapColor);
        }

        private DirtType(int metadata, String name, String unlocalizedName, MapColor mapColor)
        {
