...
public class BlockPattern
{
    ...
    public static LoadingCache<BlockPos, BlockWorldState> createLoadingCache(World world, boolean allowMissing)
    {
        return CacheBuilder.newBuilder().<BlockPos, BlockWorldState>build(new BlockPattern.CacheLoader(world, allowMissing));
    }
    ...
    static class CacheLoader extends com.google.common.cache.CacheLoader<BlockPos, BlockWorldState>
    {
        ...
        public CacheLoader(World worldIn, boolean allowMissingIn)
        {
            this.world = worldIn;
            this.allowMissing = allowMissingIn;
        }

        public BlockWorldState load(BlockPos pos) throws Exception
        {
            return new BlockWorldState(this.world, pos, this.allowMissing);
        }
    }
    ...
    public static class PatternHelper
    {
        ...
        public PatternHelper(BlockPos posIn, EnumFacing fingerIn, EnumFacing thumbIn, LoadingCache<BlockPos, BlockWorldState> lcacheIn, int palmLengthIn, int thumbLengthIn, int fingerLengthIn)
        {
            this.pos = posIn;
            this.finger = fingerIn;
            this.thumb = thumbIn;
            this.lcache = lcacheIn;
            this.palmLength = palmLengthIn;
            this.thumbLength = thumbLengthIn;
            this.fingerLength = fingerLengthIn;
        }
