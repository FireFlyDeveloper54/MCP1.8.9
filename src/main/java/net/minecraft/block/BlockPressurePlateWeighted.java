...
public class BlockPressurePlateWeighted extends BlockBasePressurePlate
{
    ...
    protected BlockPressurePlateWeighted(Material materialIn, int maxWeight)
    {
        this(materialIn, maxWeight, materialIn.getMaterialMapColor());
    }

    protected BlockPressurePlateWeighted(Material materialIn, int maxWeight, MapColor mapColorIn)
    {
