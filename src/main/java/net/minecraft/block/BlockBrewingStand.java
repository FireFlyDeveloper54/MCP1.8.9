...
public class BlockBrewingStand extends BlockContainer
{
    ...
    {
        double doubleValue = (double)((float)pos.getX() + 0.4F + rand.nextFloat() * 0.2F);
        double secondDoubleValue = (double)((float)pos.getY() + 0.7F + rand.nextFloat() * 0.3F);
        double thirdDoubleValue = (double)((float)pos.getZ() + 0.4F + rand.nextFloat() * 0.2F);
