...
public class BlockEndPortal extends BlockContainer
{
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        double secondDoubleValue = (double)((float)pos.getY() + 0.8F);
        double thirdDoubleValue = (double)((float)pos.getZ() + rand.nextFloat());
        double fourthDoubleValue = 0.0D;
        double fifthDoubleValue = 0.0D;
        double sixthDoubleValue = 0.0D;
        worldIn.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, doubleValue, secondDoubleValue, thirdDoubleValue, fourthDoubleValue, fifthDoubleValue, sixthDoubleValue, EnumParticleTypes.EMPTY_ARGS);
    }
