...
public class BlockSapling extends BlockBush implements IGrowable
{
    ...
    private boolean isTwoByTwoOfType(World worldIn, BlockPos pos, int offsetX, int offsetZ, BlockPlanks.EnumType type)
    {
        return this.isTypeAt(worldIn, pos.add(offsetX, 0, offsetZ), type) && this.isTypeAt(worldIn, pos.add(offsetX + 1, 0, offsetZ), type) && this.isTypeAt(worldIn, pos.add(offsetX, 0, offsetZ + 1), type) && this.isTypeAt(worldIn, pos.add(offsetX + 1, 0, offsetZ + 1), type);
    }
