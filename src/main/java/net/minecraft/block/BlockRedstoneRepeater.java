...
public class BlockRedstoneRepeater extends BlockRedstoneDiode
{
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        if (this.isRepeaterPowered)
        {
            ...
            double doubleValue = (double)((float)pos.getX() + 0.5F) + (double)(rand.nextFloat() - 0.5F) * 0.2D;
            double secondDoubleValue = (double)((float)pos.getY() + 0.4F) + (double)(rand.nextFloat() - 0.5F) * 0.2D;
            double thirdDoubleValue = (double)((float)pos.getZ() + 0.5F) + (double)(rand.nextFloat() - 0.5F) * 0.2D;
            float f = -5.0F;
            ...
            f = f / 16.0F;
            double fourthDoubleValue = (double)(f * (float)enumfacing.getFrontOffsetX());
            double fifthDoubleValue = (double)(f * (float)enumfacing.getFrontOffsetZ());
            worldIn.spawnParticle(EnumParticleTypes.REDSTONE, doubleValue + fourthDoubleValue, secondDoubleValue, thirdDoubleValue + fifthDoubleValue, 0.0D, 0.0D, 0.0D, EnumParticleTypes.EMPTY_ARGS);
        }
    }
