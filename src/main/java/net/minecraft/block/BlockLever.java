...
public class BlockLever extends Block
{
    ...
    {
        return BlockButton.canPlaceAt(worldIn, pos, facing);
    }
    ...
    {
        if (this.checkForDrop(worldIn, pos, state) && !canAttachTo(worldIn, pos, ((BlockLever.EnumOrientation)state.getValue(FACING)).getFacing().getOpposite()))
        {
    ...
    public static enum EnumOrientation implements IStringSerializable
    {
        ...
        public static final BlockLever.EnumOrientation[] VALUES = values();
