...
public class AchievementList
{
    ...
    public static Achievement exploreAllBiomes = (new Achievement("achievement.exploreAllBiomes", "exploreAllBiomes", 4, 8, Items.diamond_boots, theEnd)).setSerializableClass(JsonSerializableSet.class).setSpecial().registerStat();
