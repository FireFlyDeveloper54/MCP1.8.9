...
public class Achievement extends StatBase
{
    ...
    public Achievement setSerializableClass(Class <? extends IJsonSerializable > serializableClass)
    {
        return (Achievement)super.setSerializableClass(serializableClass);
    }
