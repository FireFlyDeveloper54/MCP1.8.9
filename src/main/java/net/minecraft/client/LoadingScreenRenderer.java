            ...
            if (i - this.systemTime >= 100L)
            {
                ...
                if (flag)
                {
                    ...
                    if (progress >= 0)
                    {
                        ...
                        int secondIntValue = k / 2 - intValue / 2;
                        int thirdIntValue = l / 2 + 16;
                        GlStateManager.disableTexture2D();
                        worldrenderer.begin(7, DefaultVertexFormats.POSITION_COLOR);
                        worldrenderer.pos((double)secondIntValue, (double)thirdIntValue, 0.0D).color(128, 128, 128, 255).endVertex();
                        worldrenderer.pos((double)secondIntValue, (double)(thirdIntValue + progressBarHeight), 0.0D).color(128, 128, 128, 255).endVertex();
                        worldrenderer.pos((double)(secondIntValue + intValue), (double)(thirdIntValue + progressBarHeight), 0.0D).color(128, 128, 128, 255).endVertex();
                        worldrenderer.pos((double)(secondIntValue + intValue), (double)thirdIntValue, 0.0D).color(128, 128, 128, 255).endVertex();
                        worldrenderer.pos((double)secondIntValue, (double)thirdIntValue, 0.0D).color(128, 255, 128, 255).endVertex();
                        worldrenderer.pos((double)secondIntValue, (double)(thirdIntValue + progressBarHeight), 0.0D).color(128, 255, 128, 255).endVertex();
                        worldrenderer.pos((double)(secondIntValue + progress), (double)(thirdIntValue + progressBarHeight), 0.0D).color(128, 255, 128, 255).endVertex();
                        worldrenderer.pos((double)(secondIntValue + progress), (double)thirdIntValue, 0.0D).color(128, 255, 128, 255).endVertex();
                        tessellator.draw();
