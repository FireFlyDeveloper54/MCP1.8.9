...
public class NetHandlerLoginClient implements INetHandlerLoginClient
{
    ...
    public NetHandlerLoginClient(NetworkManager networkManagerIn, Minecraft mcIn, GuiScreen previousGuiScreenIn)
    {
    ...
    public void handleEncryptionRequest(S01PacketEncryptionRequest packetIn)
    {
        ...
        String serverHash = (new BigInteger(CryptManager.getServerIdHash(serverId, publicKey, secretKey))).toString(16);
        ...
        if (this.mc.getCurrentServerData() != null && this.mc.getCurrentServerData().isOnLAN())
        {
            ...
            catch (AuthenticationException caughtAuthenticationException)
            {
        ...
        else
        {
            ...
            catch (AuthenticationUnavailableException caughtAuthenticationUnavailableException)
            {
            ...
            catch (InvalidCredentialsException caughtInvalidCredentialsException)
            {
