...
public abstract class AbstractResourcePack implements IResourcePack
{
    ...
    protected static String getRelativeName(File root, File file)
    {
    ...
    static <T extends IMetadataSection> T readMetadata(IMetadataSerializer metadataSerializer, InputStream inputStream, String metadataSectionName)
    {
