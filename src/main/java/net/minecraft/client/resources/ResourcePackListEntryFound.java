...
public class ResourcePackListEntryFound extends ResourcePackListEntry
{
    ...
    public ResourcePackListEntryFound(GuiScreenResourcePacks resourcePacksGUIIn, ResourcePackRepository.Entry resourcePackEntryIn)
    {
        super(resourcePacksGUIIn);
        this.resourcePackEntry = resourcePackEntryIn;
    }
