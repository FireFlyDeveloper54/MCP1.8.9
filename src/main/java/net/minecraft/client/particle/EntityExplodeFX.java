...
public class EntityExplodeFX extends EntityFX
{
    protected EntityExplodeFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn)
    {
        ...
        this.motionX = xSpeedIn + (this.rand.nextDouble() * 2.0D - 1.0D) * 0.05000000074505806D;
        this.motionY = ySpeedIn + (this.rand.nextDouble() * 2.0D - 1.0D) * 0.05000000074505806D;
        this.motionZ = zSpeedIn + (this.rand.nextDouble() * 2.0D - 1.0D) * 0.05000000074505806D;
