...
public class EntityBlockDustFX extends EntityDiggingFX
{
    ...
    public static class Factory implements IParticleFactory
    {
        ...
        {
            IBlockState iblockstate = Block.getStateById(parameters[0]);
            return iblockstate.getBlock().getRenderType() == -1 ? null : (new EntityBlockDustFX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn, iblockstate)).applyRenderColor();
        }
    }
}
