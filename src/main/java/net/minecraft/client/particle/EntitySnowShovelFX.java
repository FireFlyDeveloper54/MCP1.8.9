...
public class EntitySnowShovelFX extends EntityFX
{
    ...
    protected EntitySnowShovelFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, float scale)
    {
        ...
        this.particleRed = this.particleGreen = this.particleBlue = 1.0F - (float)(this.rand.nextDouble() * 0.30000001192092896D);
    ...
    public void renderParticle(WorldRenderer worldRendererIn, Entity entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ)
    {
        ...
        this.particleScale = this.snowDigParticleScale * scaleProgress;
