...
public class ServerSelectionList extends GuiListExtended
{
    ...
    public void updateOnlineServers(ServerList serverList)
    {
        ...
        for (int serverIndex = 0; serverIndex < serverList.countServers(); ++serverIndex)
        {
            this.serverListInternet.add(new ServerListEntryNormal(this.owner, serverList.getServerData(serverIndex)));
        }
    }
    ...
    public void updateNetworkServers(List<LanServerDetector.LanServer> lanServers)
    {
        ...
        for (LanServerDetector.LanServer lanServer : lanServers)
        {
            this.serverListLan.add(new ServerListEntryLanDetected(this.owner, lanServer));
        }
    }
