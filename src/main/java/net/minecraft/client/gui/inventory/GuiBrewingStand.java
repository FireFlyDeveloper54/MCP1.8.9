...
public class GuiBrewingStand extends GuiContainer
{
    ...
    public GuiBrewingStand(InventoryPlayer playerInventoryIn, IInventory tileBrewingStandIn)
    {
        super(new ContainerBrewingStand(playerInventoryIn, tileBrewingStandIn));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        if (k > 0)
        {
            ...
            int brewBubbleFrame = k / 2 % 7;

            switch (brewBubbleFrame)
            {
                case 0:
                    l = 29;
                    break;
