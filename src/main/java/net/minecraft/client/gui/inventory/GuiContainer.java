...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int intValue = 0; intValue < this.inventorySlots.inventorySlots.size(); ++intValue)
        {
            Slot slot = this.inventorySlots.inventorySlots.get(intValue);
            this.drawSlot(slot);
            ...
            if (this.isMouseOverSlot(slot, mouseX, mouseY) && slot.canBeHovered())
            {
                ...
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                int secondIntValue = slot.xDisplayPosition;
                int thirdIntValue = slot.yDisplayPosition;
                GlStateManager.colorMask(true, true, true, false);
                this.drawGradientRect(secondIntValue, thirdIntValue, secondIntValue + 16, thirdIntValue + 16, -2130706433, -2130706433);
        ...
        if (itemstack != null)
        {
            int fourthIntValue = 8;
            int fifthIntValue = this.draggedStack == null ? 8 : 16;
            String s = null;
            ...
            this.drawItemStack(itemstack, mouseX - i - fourthIntValue, mouseY - j - fifthIntValue, s);
        }
        ...
        if (this.returningStack != null)
        {
            ...
            int tenthIntValue = this.returningStackDestSlot.xDisplayPosition - this.touchUpX;
            int sixthIntValue = this.returningStackDestSlot.yDisplayPosition - this.touchUpY;
            int seventhIntValue = this.touchUpX + (int)((float)tenthIntValue * f);
            int eighthIntValue = this.touchUpY + (int)((float)sixthIntValue * f);
            this.drawItemStack(this.returningStack, seventhIntValue, eighthIntValue, (String)null);
        }
    ...
    private void drawSlot(Slot slotIn)
    {
        ...
        if (itemStack == null)
        {
            String text2 = slotIn.getSlotTexture();

            if (text2 != null)
            {
                TextureAtlasSprite textureAtlasSprite = this.mc.getTextureMapBlocks().getAtlasSprite(text2);
                GlStateManager.disableLighting();
                ...
                else if (!this.dragSplitting)
                {
                    if (this.mc.thePlayer.inventory.getItemStack() == null)
                    {
                        ...
                        else
                        {
                            ...
                            this.handleMouseClick(slot, l, mouseButton, ninthIntValue);
                        }
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state)
    {
        ...
        else
        {
            ...
            {
                this.handleMouseClick((Slot)null, -999, Container.combineDragData(0, this.dragSplittingLimit), 5);

                for (Slot slot1 : this.dragSplittingSlots)
                {
                    this.handleMouseClick(slot1, slot1.slotNumber, Container.combineDragData(1, this.dragSplittingLimit), 5);
                }

                this.handleMouseClick((Slot)null, -999, Container.combineDragData(2, this.dragSplittingLimit), 5);
            }
