...
public class GuiGameOver extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        boolean hardcoreMode = this.mc.theWorld.getWorldInfo().isHardcoreModeEnabled();
        String titleText = hardcoreMode ? I18n.format("deathScreen.title.hardcore", new Object[0]) : I18n.format("deathScreen.title", new Object[0]);
