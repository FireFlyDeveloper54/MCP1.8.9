...
public class GuiMerchant extends GuiContainer
{
    ...
    public GuiMerchant(InventoryPlayer playerInventory, IMerchant merchantIn, World worldIn)
    {
        super(new ContainerMerchant(playerInventory, merchantIn, worldIn));
    ...
    static class MerchantButton extends GuiButton
    {
        ...
        public MerchantButton(int buttonID, int x, int y, boolean forwardIn)
        {
