...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public GuiCreateWorld(GuiScreen parentScreenIn)
    {
    ...
    private void calcSaveDirName()
    {
        ...
        for (char character : ChatAllowedCharacters.allowedCharactersArray)
        {
            this.saveDirName = this.saveDirName.replace(character, '_');
        }
