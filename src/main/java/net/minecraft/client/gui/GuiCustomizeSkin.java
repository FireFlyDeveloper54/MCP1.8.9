...
public class GuiCustomizeSkin extends GuiScreen
{
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button instanceof GuiCustomizeSkin.ButtonPart)
            {
                ...
                button.displayString = this.getButtonLabel(enumplayermodelparts);
            }
        }
    }
    ...
    private String getButtonLabel(EnumPlayerModelParts playerModelParts)
    {
        String s;
        ...
        return playerModelParts.getDisplayName().getFormattedText() + ": " + s;
    }
    ...
    class ButtonPart extends GuiButton
    {
        ...
        {
            super(buttonId, x, y, width, height, GuiCustomizeSkin.this.getButtonLabel(playerModelParts));
