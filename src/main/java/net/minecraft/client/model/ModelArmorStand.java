...
public class ModelArmorStand extends ModelArmorStandArmor
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (entityIn instanceof EntityArmorStand)
        {
            ...
            float baseRotationX = (entityArmorStand.getLeftLegRotation().getX() + entityArmorStand.getRightLegRotation().getX()) / 2.0F;
            float baseRotationY = (entityArmorStand.getLeftLegRotation().getY() + entityArmorStand.getRightLegRotation().getY()) / 2.0F;
            float baseRotationZ = (entityArmorStand.getLeftLegRotation().getZ() + entityArmorStand.getRightLegRotation().getZ()) / 2.0F;
    ...
    {
        boolean wasRightArmVisible = this.bipedRightArm.showModel;
        this.bipedRightArm.showModel = true;
        super.postRenderArm(scale);
        this.bipedRightArm.showModel = wasRightArmVisible;
    }
}
