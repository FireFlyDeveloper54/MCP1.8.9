...
public class ModelRabbit extends ModelBase
{
    ...
    private float savedLimbSwingAmount = 0.0F;
    ...
    private void setRotationOffset(ModelRenderer renderer, float xRotation, float yRotation, float zRotation)
    {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        this.jumpRotation = MathHelper.sin(entityRabbit.getJumpCompletion(partialTicks) * (float)Math.PI);
