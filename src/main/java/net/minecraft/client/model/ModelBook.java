...
public class ModelBook extends ModelBase
{
    ...
    {
        float openAngle = (MathHelper.sin(limbSwing * 0.02F) * 0.1F + 1.25F) * netHeadYaw;
        ...
        this.flippingPageRight.rotateAngleY = openAngle - openAngle * 2.0F * limbSwingAmount;
        this.flippingPageLeft.rotateAngleY = openAngle - openAngle * 2.0F * ageInTicks;
