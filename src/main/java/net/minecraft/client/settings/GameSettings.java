    ...
    public String getKeyBinding(GameSettings.Options settingOption)
    {
        ...
        else
        {
            ...
            if (settingOption.getEnumFloat())
            {
                ...
                return settingOption == GameSettings.Options.MIPMAP_LEVELS && (double)floatValue >= 4.0D ? stringValue + Lang.get("of.general.max") : (settingOption == GameSettings.Options.SENSITIVITY ? (f == 0.0F ? stringValue + I18n.format("options.sensitivity.min", new Object[0]) : (f == 1.0F ? stringValue + I18n.format("options.sensitivity.max", new Object[0]) : stringValue + (int)(f * 200.0F) + "%")) : (settingOption == GameSettings.Options.FOV ? (floatValue == 70.0F ? stringValue + I18n.format("options.fov.min", new Object[0]) : (floatValue == 110.0F ? stringValue + I18n.format("options.fov.max", new Object[0]) : stringValue + (int)floatValue)) : (settingOption == GameSettings.Options.FRAMERATE_LIMIT ? (floatValue == settingOption.valueMax ? stringValue + I18n.format("options.framerateLimit.max", new Object[0]) : stringValue + (int)floatValue + " fps") : (settingOption == GameSettings.Options.RENDER_CLOUDS ? (floatValue == settingOption.valueMin ? stringValue + I18n.format("options.cloudHeight.min", new Object[0]) : stringValue + ((int)floatValue + 128)) : (settingOption == GameSettings.Options.GAMMA ? (f == 0.0F ? stringValue + I18n.format("options.gamma.min", new Object[0]) : (f == 1.0F ? stringValue + I18n.format("options.gamma.max", new Object[0]) : stringValue + "+" + (int)(f * 100.0F) + "%")) : (settingOption == GameSettings.Options.SATURATION ? stringValue + (int)(f * 400.0F) + "%" : (settingOption == GameSettings.Options.CHAT_OPACITY ? stringValue + (int)(f * 90.0F + 10.0F) + "%" : (settingOption == GameSettings.Options.CHAT_HEIGHT_UNFOCUSED ? stringValue + GuiNewChat.calculateChatboxHeight(f) + "px" : (settingOption == GameSettings.Options.CHAT_HEIGHT_FOCUSED ? stringValue + GuiNewChat.calculateChatboxHeight(f) + "px" : (settingOption == GameSettings.Options.CHAT_WIDTH ? stringValue + GuiNewChat.calculateChatboxWidth(f) + "px" : (settingOption == GameSettings.Options.RENDER_DISTANCE ? stringValue + (int)floatValue + " chunks" : (settingOption == GameSettings.Options.MIPMAP_LEVELS ? (floatValue == 0.0F ? stringValue + I18n.format("options.off", new Object[0]) : stringValue + (int)floatValue) : (settingOption == GameSettings.Options.STREAM_FPS ? stringValue + TwitchStream.formatStreamFps(f) + " fps" : (settingOption == GameSettings.Options.STREAM_KBPS ? stringValue + TwitchStream.formatStreamKbps(f) + " Kbps" : (settingOption == GameSettings.Options.STREAM_BYTES_PER_PIXEL ? stringValue + String.format(Locale.ROOT, "%.3f bpp", TwitchStream.formatStreamBps(f)): (f == 0.0F ? stringValue + I18n.format("options.off", new Object[0]) : stringValue + (int)(f * 100.0F) + "%"))))))))))))))));
            }
