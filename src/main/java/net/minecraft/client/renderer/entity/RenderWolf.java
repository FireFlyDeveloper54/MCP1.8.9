...
public class RenderWolf extends RenderLiving<EntityWolf>
{
    ...
    public void doRender(EntityWolf entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (entity.isWolfWet())
        {
            float wetBrightness = entity.getBrightness(partialTicks) * entity.getShadingWhileWet(partialTicks);
            GlStateManager.color(wetBrightness, wetBrightness, wetBrightness);
        }
