...
public class LayerMooshroomMushroom implements LayerRenderer<EntityMooshroom>
{
    ...
    public LayerMooshroomMushroom(RenderMooshroom mooshroomRendererIn)
    {
        ...
        int[][] zPlaneFaceTextures = new int[][] {null, null, {16, 16, 0, 0}, {16, 16, 0, 0}, null, null};
        this.modelRendererMushroom.addBox(zPlaneFaceTextures, 0.0F, 0.0F, 10.0F, 20.0F, 16.0F, 0.0F, 0.0F);
        int[][] xPlaneFaceTextures = new int[][] {null, null, null, null, {16, 16, 0, 0}, {16, 16, 0, 0}};
        this.modelRendererMushroom.addBox(xPlaneFaceTextures, 10.0F, 0.0F, 0.0F, 0.0F, 16.0F, 20.0F, 0.0F);
    }
