...
public class RenderEnderCrystal extends Render<EntityEnderCrystal>
{
    ...
    public void doRender(EntityEnderCrystal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        float bobOffset = MathHelper.sin(rotationTicks * 0.2F) / 2.0F + 0.5F;
        bobOffset = bobOffset * bobOffset + bobOffset;
        this.modelEnderCrystal.render(entity, 0.0F, rotationTicks * 3.0F, bobOffset * 0.2F, 0.0F, 0.0F, 0.0625F);
