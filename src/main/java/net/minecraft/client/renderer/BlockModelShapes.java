...
public class BlockModelShapes
{
    ...
    public TextureAtlasSprite getTexture(IBlockState state)
    {
        ...
        IBakedModel bakedModel = this.getModelForState(state);
    ...
    {
        IBakedModel bakedModel = this.bakedModelStore.get(state);
    ...
    private void registerAllBlocks()
    {
        ...
        this.registerBlockWithStateMapper(Blocks.quartz_block, new StateMapperBase()
        {
            ...
            {
                BlockQuartz.EnumType quartzType = (BlockQuartz.EnumType)state.getValue(BlockQuartz.VARIANT);
        ...
        this.registerBlockWithStateMapper(Blocks.dirt, new StateMapperBase()
        {
            ...
            {
                Map<IProperty, Comparable> map = Maps.<IProperty, Comparable>newLinkedHashMap(state.getProperties());
                String variantName = BlockDirt.VARIANT.getName((BlockDirt.DirtType)map.remove(BlockDirt.VARIANT));
        ...
        this.registerBlockWithStateMapper(Blocks.double_stone_slab, new StateMapperBase()
        {
            ...
            {
                Map<IProperty, Comparable> map = Maps.<IProperty, Comparable>newLinkedHashMap(state.getProperties());
                String variantName = BlockStoneSlab.VARIANT.getName((BlockStoneSlab.EnumType)map.remove(BlockStoneSlab.VARIANT));
                map.remove(BlockStoneSlab.SEAMLESS);
                String seamlessVariant = ((Boolean)state.getValue(BlockStoneSlab.SEAMLESS)).booleanValue() ? "all" : "normal";
                return new ModelResourceLocation(variantName + "_double_slab", seamlessVariant);
            }
        });
        this.registerBlockWithStateMapper(Blocks.double_stone_slab2, new StateMapperBase()
        {
            ...
            {
                Map<IProperty, Comparable> map = Maps.<IProperty, Comparable>newLinkedHashMap(state.getProperties());
                String variantName = BlockStoneSlabNew.VARIANT.getName((BlockStoneSlabNew.EnumType)map.remove(BlockStoneSlabNew.VARIANT));
                map.remove(BlockStoneSlab.SEAMLESS);
                String seamlessVariant = ((Boolean)state.getValue(BlockStoneSlabNew.SEAMLESS)).booleanValue() ? "all" : "normal";
                return new ModelResourceLocation(variantName + "_double_slab", seamlessVariant);
            }
        });
    }
