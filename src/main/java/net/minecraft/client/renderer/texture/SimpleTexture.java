...
public class SimpleTexture extends AbstractTexture
{
    ...
    public void loadTexture(IResourceManager resourceManager) throws IOException
    {
        ...
        try
        {
            ...
            boolean textureBlur = false;
            boolean textureClamp = false;
            ...
            if (Config.isShaders())
            {
                ShadersTex.loadSimpleTexture(this.getGlTextureId(), bufferedimage, textureBlur, textureClamp, resourceManager, this.textureLocation, this.getMultiTexID());
            }
            else
            {
                TextureUtil.uploadTextureImageAllocate(this.getGlTextureId(), bufferedimage, textureBlur, textureClamp);
            }
