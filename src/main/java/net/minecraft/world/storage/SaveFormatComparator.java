...
public class SaveFormatComparator implements Comparable<SaveFormatComparator>
{
    ...
    public int compareTo(SaveFormatComparator saveFormat)
    {
        return this.lastTimePlayed < saveFormat.lastTimePlayed ? 1 : (this.lastTimePlayed > saveFormat.lastTimePlayed ? -1 : this.fileName.compareTo(saveFormat.fileName));
    }
