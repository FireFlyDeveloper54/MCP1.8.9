...
public class WorldInfo
{
    ...
    public void addToCrashReport(CrashReportCategory category)
    {
        ...
        category.addCrashSectionCallable("Level generator", new Callable<String>()
        {
            public String call() throws Exception
            {
                return String.format(Locale.ROOT, "ID %02d - %s, ver %d. Features enabled: %b", WorldInfo.this.terrainType.getWorldTypeID(), WorldInfo.this.terrainType.getWorldTypeName(), WorldInfo.this.terrainType.getGeneratorVersion(), WorldInfo.this.mapFeaturesEnabled);
            }
        });
        ...
        category.addCrashSectionCallable("Level time", new Callable<String>()
        {
            public String call() throws Exception
            {
                return WorldInfo.this.totalTime + " game time, " + WorldInfo.this.worldTime + " day time";
            }
        });
        ...
        category.addCrashSectionCallable("Level storage version", new Callable<String>()
        {
            public String call() throws Exception
            {
                ...
                return String.format(Locale.ROOT, "0x%05X - %s", WorldInfo.this.saveVersion, s);
            }
        });
        category.addCrashSectionCallable("Level weather", new Callable<String>()
        {
            public String call() throws Exception
            {
                return "Rain time: " + WorldInfo.this.rainTime + " (now: " + WorldInfo.this.raining + "), thunder time: " + WorldInfo.this.thunderTime + " (now: " + WorldInfo.this.thundering + ")";
            }
        });
        category.addCrashSectionCallable("Level game mode", new Callable<String>()
        {
            public String call() throws Exception
            {
                return "Game mode: " + WorldInfo.this.theGameType.getName() + " (ID " + WorldInfo.this.theGameType.getID() + "). Hardcore: " + WorldInfo.this.hardcore + ". Cheats: " + WorldInfo.this.allowCommands;
            }
        });
    }
}
