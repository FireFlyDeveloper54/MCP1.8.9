...
public class GameRules
{
    ...
    {
        for (String ruleName : nbt.getKeySet())
        {
            String ruleValue = nbt.getString(ruleName);
            this.setOrCreateGameRule(ruleName, ruleValue);
        }
    }
    ...
    static class Value
    {
        ...
        {
            if (value == null ? this.valueString == null : value.equals(this.valueString))
            {
                return;
            }
