...
public class WorldChunkManagerHell extends WorldChunkManager
{
    ...
    public WorldChunkManagerHell(BiomeGenBase biomeGeneratorIn, float rainfallIn)
    {
        this.biomeGenerator = biomeGeneratorIn;
    ...
    {
        return allowedBiomes.contains(this.biomeGenerator);
    }
}
