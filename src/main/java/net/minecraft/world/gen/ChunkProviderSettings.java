...
public class ChunkProviderSettings
{
    ...
    public static class Factory
    {
        ...
        public static ChunkProviderSettings.Factory jsonToFactory(String json)
        {
            ...
            else
            {
                try
                {
                    return (ChunkProviderSettings.Factory)JSON_ADAPTER.fromJson(json, ChunkProviderSettings.Factory.class);
                }
        ...
        public boolean equals(Object other)
        {
            ...
            {
                ChunkProviderSettings.Factory chunkprovidersettings$factory = (ChunkProviderSettings.Factory)other;
    ...
    {
        public ChunkProviderSettings.Factory deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
        {
        ...
        public JsonElement serialize(ChunkProviderSettings.Factory settings, Type typeOfSrc, JsonSerializationContext context)
        {
            JsonObject jsonObject = new JsonObject();
            jsonObject.addProperty("coordinateScale", (Number)Float.valueOf(settings.coordinateScale));
            jsonObject.addProperty("heightScale", (Number)Float.valueOf(settings.heightScale));
            jsonObject.addProperty("lowerLimitScale", (Number)Float.valueOf(settings.lowerLimitScale));
            jsonObject.addProperty("upperLimitScale", (Number)Float.valueOf(settings.upperLimitScale));
            jsonObject.addProperty("depthNoiseScaleX", (Number)Float.valueOf(settings.depthNoiseScaleX));
            jsonObject.addProperty("depthNoiseScaleZ", (Number)Float.valueOf(settings.depthNoiseScaleZ));
            jsonObject.addProperty("depthNoiseScaleExponent", (Number)Float.valueOf(settings.depthNoiseScaleExponent));
            jsonObject.addProperty("mainNoiseScaleX", (Number)Float.valueOf(settings.mainNoiseScaleX));
            jsonObject.addProperty("mainNoiseScaleY", (Number)Float.valueOf(settings.mainNoiseScaleY));
            jsonObject.addProperty("mainNoiseScaleZ", (Number)Float.valueOf(settings.mainNoiseScaleZ));
            jsonObject.addProperty("baseSize", (Number)Float.valueOf(settings.baseSize));
            jsonObject.addProperty("stretchY", (Number)Float.valueOf(settings.stretchY));
            jsonObject.addProperty("biomeDepthWeight", (Number)Float.valueOf(settings.biomeDepthWeight));
            jsonObject.addProperty("biomeDepthOffset", (Number)Float.valueOf(settings.biomeDepthOffset));
            jsonObject.addProperty("biomeScaleWeight", (Number)Float.valueOf(settings.biomeScaleWeight));
            jsonObject.addProperty("biomeScaleOffset", (Number)Float.valueOf(settings.biomeScaleOffset));
            jsonObject.addProperty("seaLevel", (Number)Integer.valueOf(settings.seaLevel));
            jsonObject.addProperty("useCaves", Boolean.valueOf(settings.useCaves));
            jsonObject.addProperty("useDungeons", Boolean.valueOf(settings.useDungeons));
            jsonObject.addProperty("dungeonChance", (Number)Integer.valueOf(settings.dungeonChance));
            jsonObject.addProperty("useStrongholds", Boolean.valueOf(settings.useStrongholds));
            jsonObject.addProperty("useVillages", Boolean.valueOf(settings.useVillages));
            jsonObject.addProperty("useMineShafts", Boolean.valueOf(settings.useMineShafts));
            jsonObject.addProperty("useTemples", Boolean.valueOf(settings.useTemples));
            jsonObject.addProperty("useMonuments", Boolean.valueOf(settings.useMonuments));
            jsonObject.addProperty("useRavines", Boolean.valueOf(settings.useRavines));
            jsonObject.addProperty("useWaterLakes", Boolean.valueOf(settings.useWaterLakes));
            jsonObject.addProperty("waterLakeChance", (Number)Integer.valueOf(settings.waterLakeChance));
            jsonObject.addProperty("useLavaLakes", Boolean.valueOf(settings.useLavaLakes));
            jsonObject.addProperty("lavaLakeChance", (Number)Integer.valueOf(settings.lavaLakeChance));
            jsonObject.addProperty("useLavaOceans", Boolean.valueOf(settings.useLavaOceans));
            jsonObject.addProperty("fixedBiome", (Number)Integer.valueOf(settings.fixedBiome));
            jsonObject.addProperty("biomeSize", (Number)Integer.valueOf(settings.biomeSize));
            jsonObject.addProperty("riverSize", (Number)Integer.valueOf(settings.riverSize));
            jsonObject.addProperty("dirtSize", (Number)Integer.valueOf(settings.dirtSize));
            jsonObject.addProperty("dirtCount", (Number)Integer.valueOf(settings.dirtCount));
            jsonObject.addProperty("dirtMinHeight", (Number)Integer.valueOf(settings.dirtMinHeight));
            jsonObject.addProperty("dirtMaxHeight", (Number)Integer.valueOf(settings.dirtMaxHeight));
            jsonObject.addProperty("gravelSize", (Number)Integer.valueOf(settings.gravelSize));
            jsonObject.addProperty("gravelCount", (Number)Integer.valueOf(settings.gravelCount));
            jsonObject.addProperty("gravelMinHeight", (Number)Integer.valueOf(settings.gravelMinHeight));
            jsonObject.addProperty("gravelMaxHeight", (Number)Integer.valueOf(settings.gravelMaxHeight));
            jsonObject.addProperty("graniteSize", (Number)Integer.valueOf(settings.graniteSize));
            jsonObject.addProperty("graniteCount", (Number)Integer.valueOf(settings.graniteCount));
            jsonObject.addProperty("graniteMinHeight", (Number)Integer.valueOf(settings.graniteMinHeight));
            jsonObject.addProperty("graniteMaxHeight", (Number)Integer.valueOf(settings.graniteMaxHeight));
            jsonObject.addProperty("dioriteSize", (Number)Integer.valueOf(settings.dioriteSize));
            jsonObject.addProperty("dioriteCount", (Number)Integer.valueOf(settings.dioriteCount));
            jsonObject.addProperty("dioriteMinHeight", (Number)Integer.valueOf(settings.dioriteMinHeight));
            jsonObject.addProperty("dioriteMaxHeight", (Number)Integer.valueOf(settings.dioriteMaxHeight));
            jsonObject.addProperty("andesiteSize", (Number)Integer.valueOf(settings.andesiteSize));
            jsonObject.addProperty("andesiteCount", (Number)Integer.valueOf(settings.andesiteCount));
            jsonObject.addProperty("andesiteMinHeight", (Number)Integer.valueOf(settings.andesiteMinHeight));
            jsonObject.addProperty("andesiteMaxHeight", (Number)Integer.valueOf(settings.andesiteMaxHeight));
            jsonObject.addProperty("coalSize", (Number)Integer.valueOf(settings.coalSize));
            jsonObject.addProperty("coalCount", (Number)Integer.valueOf(settings.coalCount));
            jsonObject.addProperty("coalMinHeight", (Number)Integer.valueOf(settings.coalMinHeight));
            jsonObject.addProperty("coalMaxHeight", (Number)Integer.valueOf(settings.coalMaxHeight));
            jsonObject.addProperty("ironSize", (Number)Integer.valueOf(settings.ironSize));
            jsonObject.addProperty("ironCount", (Number)Integer.valueOf(settings.ironCount));
            jsonObject.addProperty("ironMinHeight", (Number)Integer.valueOf(settings.ironMinHeight));
            jsonObject.addProperty("ironMaxHeight", (Number)Integer.valueOf(settings.ironMaxHeight));
            jsonObject.addProperty("goldSize", (Number)Integer.valueOf(settings.goldSize));
            jsonObject.addProperty("goldCount", (Number)Integer.valueOf(settings.goldCount));
            jsonObject.addProperty("goldMinHeight", (Number)Integer.valueOf(settings.goldMinHeight));
            jsonObject.addProperty("goldMaxHeight", (Number)Integer.valueOf(settings.goldMaxHeight));
            jsonObject.addProperty("redstoneSize", (Number)Integer.valueOf(settings.redstoneSize));
            jsonObject.addProperty("redstoneCount", (Number)Integer.valueOf(settings.redstoneCount));
            jsonObject.addProperty("redstoneMinHeight", (Number)Integer.valueOf(settings.redstoneMinHeight));
            jsonObject.addProperty("redstoneMaxHeight", (Number)Integer.valueOf(settings.redstoneMaxHeight));
            jsonObject.addProperty("diamondSize", (Number)Integer.valueOf(settings.diamondSize));
            jsonObject.addProperty("diamondCount", (Number)Integer.valueOf(settings.diamondCount));
            jsonObject.addProperty("diamondMinHeight", (Number)Integer.valueOf(settings.diamondMinHeight));
            jsonObject.addProperty("diamondMaxHeight", (Number)Integer.valueOf(settings.diamondMaxHeight));
            jsonObject.addProperty("lapisSize", (Number)Integer.valueOf(settings.lapisSize));
            jsonObject.addProperty("lapisCount", (Number)Integer.valueOf(settings.lapisCount));
            jsonObject.addProperty("lapisCenterHeight", (Number)Integer.valueOf(settings.lapisCenterHeight));
            jsonObject.addProperty("lapisSpread", (Number)Integer.valueOf(settings.lapisSpread));
            return jsonObject;
        }
    }
}
