...
public class WalkNodeProcessor extends NodeProcessor
{
    ...
    private PathPoint getSafePoint(Entity entityIn, int x, int y, int z, int stepHeight)
    {
        ...
        else
        {
            ...
            if (pathPoint == null && stepHeight > 0 && i != -3 && i != -4 && this.getVerticalOffset(entityIn, x, y + stepHeight, z) == 1)
            {
                pathPoint = this.openPoint(x, y + stepHeight, z);
                y += stepHeight;
            }
    ...
    {
        return getPathNodeType(this.blockaccess, entityIn, x, y, z, this.entitySizeX, this.entitySizeY, this.entitySizeZ, this.avoidsWater, this.canBreakDoors, this.canEnterDoors);
    }
