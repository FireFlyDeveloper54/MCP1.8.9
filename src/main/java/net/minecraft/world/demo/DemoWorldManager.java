...
{
    private boolean demoIntroShown;
    private boolean demoTimeExpired;
    private int reminderTicks;
    private int demoTicksElapsed;
    ...
    public void updateBlockRemoving()
    {
        ...
        ++this.demoTicksElapsed;
        long i = this.theWorld.getTotalWorldTime();
        long j = i / 24000L + 1L;

        if (!this.demoIntroShown && this.demoTicksElapsed > 20)
        {
            this.demoIntroShown = true;
