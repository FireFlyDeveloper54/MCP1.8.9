...
public class Potion
{
    ...
    private static final Map<ResourceLocation, Potion> potionRegistry = Maps.<ResourceLocation, Potion>newHashMap();
    public static final Potion emptyPotion = null;
    ...
    public static final Potion reservedPotion1 = null;
    public static final Potion reservedPotion2 = null;
    public static final Potion reservedPotion3 = null;
    public static final Potion reservedPotion4 = null;
    public static final Potion reservedPotion5 = null;
    public static final Potion reservedPotion6 = null;
    public static final Potion reservedPotion7 = null;
    public static final Potion reservedPotion8 = null;
    public final int id;
    ...
    protected Potion(int potionID, ResourceLocation location, boolean badEffect, int potionColor)
    {
        ...
        potionRegistry.put(location, this);
    ...
    {
        return (Potion)potionRegistry.get(new ResourceLocation(location));
    }

    public static Set<ResourceLocation> getPotionLocations()
    {
        return potionRegistry.keySet();
    }

    protected Potion setIconIndex(int column, int row)
    {
        this.statusIconIndex = column + row * 8;
        return this;
    }
    ...
    public void affectEntity(Entity source, Entity indirectSource, EntityLivingBase entityLivingBaseIn, int amplifier, double healthFactor)
    {
        if ((this.id != heal.id || entityLivingBaseIn.isEntityUndead()) && (this.id != harm.id || !entityLivingBaseIn.isEntityUndead()))
        {
            if (this.id == harm.id && !entityLivingBaseIn.isEntityUndead() || this.id == heal.id && entityLivingBaseIn.isEntityUndead())
            {
                int j = (int)(healthFactor * (double)(6 << amplifier) + 0.5D);
        ...
        {
            int i = (int)(healthFactor * (double)(4 << amplifier) + 0.5D);
    ...
    public Potion registerPotionAttributeModifier(IAttribute attribute, String uuid, double amount, int operation)
    {
    ...
    public void removeAttributesModifiersFromEntity(EntityLivingBase entityLivingBaseIn, BaseAttributeMap attributeMap, int amplifier)
    {
        ...
        {
            IAttributeInstance iattributeinstance = attributeMap.getAttributeInstance((IAttribute)entry.getKey());
