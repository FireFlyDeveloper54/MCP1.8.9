...
public class RenderEnv
{
    ...
    public EnumFacing[] getBorderDirections(EnumFacing enumFacing, EnumFacing secondEnumFacing, EnumFacing thirdEnumFacing, EnumFacing fourthEnumFacing)
    {
        EnumFacing[] aenumfacing = this.getBorderDirections();
        aenumfacing[0] = enumFacing;
        aenumfacing[1] = secondEnumFacing;
        aenumfacing[2] = thirdEnumFacing;
        aenumfacing[3] = fourthEnumFacing;
        return aenumfacing;
    }
