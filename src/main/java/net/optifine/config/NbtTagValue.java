...
public class NbtTagValue
{
    ...
    public NbtTagValue(String tag, String value)
    {
        ...
        if (this.type == TYPE_REGEX || this.type == TYPE_IREGEX)
        {
            try
            {
            ...
            {
                Config.warn("Invalid NBT regex: " + value);
                this.valueRegex = Pattern.compile("$." );
            }
        }
    }
    ...
    public boolean matchesValue(String nbtValue)
    {
        ...
        else
        {
            switch (this.type)
            {
                ...
                case 3:
                    return this.matchesRegex(nbtValue);

                case 4:
                    return this.matchesRegex(nbtValue.toLowerCase());
