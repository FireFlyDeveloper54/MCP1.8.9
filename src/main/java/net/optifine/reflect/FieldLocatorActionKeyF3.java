...
public class FieldLocatorActionKeyF3 implements IFieldLocator
{
    ...
    private Field getFieldRenderChunksMany()
    {
        ...
        Set<Field> secondSet = new HashSet(Arrays.asList(afield2));
        Set<Field> thirdSet = new HashSet(set);
        thirdSet.retainAll(secondSet);
        Field[] afield3 = (Field[])((Field[])thirdSet.toArray(new Field[thirdSet.size()]));
