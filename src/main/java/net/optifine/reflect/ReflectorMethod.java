...
public class ReflectorMethod implements IResolvable
{
        ...
        else
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        Method[] methods = getMethods(oclass, this.targetMethodName);
    ...
    public static Method getMethod(Class cls, String methodName, Class[] paramTypes)
    {
        ...
        for (int methodIndex = 0; methodIndex < methods.length; ++methodIndex)
        {
            ...
            if (method.getName().equals(methodName))
            {
                ...
                if (Reflector.matchesTypes(paramTypes, methodParamTypes))
                {
                    return method;
                }
            }
    ...
    public static Method[] getMethods(Class cls, String methodName)
    {
        ...
        Method[] methodArray = (Method[])((Method[])matchingMethods.toArray(new Method[matchingMethods.size()]));
        return methodArray;
    }
