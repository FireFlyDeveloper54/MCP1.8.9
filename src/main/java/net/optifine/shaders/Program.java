...
public class Program
{
    ...
    private String drawBufferSettings;
    ...
    public void copyFrom(Program p)
    {
        ...
        this.drawBufferSettings = p.getDrawBufSettings();
    ...
    {
        return this.drawBufferSettings;
    }
    ...
    {
        this.drawBufferSettings = drawBufSettings;
    }
    ...
    public String getRealProgramName()
    {
        ...
        else
        {
            ...
            for (program = this; program.getRef() != this.programId; program = program.getProgramBackup())
            {
    ...
    {
        return "name: " + this.name + ", id: " + this.programId + ", ref: " + this.referenceId + ", real: " + this.getRealProgramName();
    }
}
