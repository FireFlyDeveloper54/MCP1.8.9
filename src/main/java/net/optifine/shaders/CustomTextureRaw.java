    ...
    public CustomTextureRaw(TextureType type, InternalFormat internalFormat, int width, int height, int depth, PixelFormat pixelFormat, PixelType pixelType, ByteBuffer data, int textureUnit, boolean blur, boolean clamp)
    {
        ...
        switch (type)
        {
            case TEXTURE_1D:
                ...
                GL11.glTexParameteri(GL11.GL_TEXTURE_1D, GL11.GL_TEXTURE_WRAP_S, wrapMode);
                GL11.glTexParameteri(GL11.GL_TEXTURE_1D, GL11.GL_TEXTURE_MAG_FILTER, filterMode);
                GL11.glTexParameteri(GL11.GL_TEXTURE_1D, GL11.GL_TEXTURE_MIN_FILTER, filterMode);
                break;
            ...
            case TEXTURE_3D:
                ...
                GL11.glTexParameteri(GL12.GL_TEXTURE_3D, GL11.GL_TEXTURE_MAG_FILTER, filterMode);
                GL11.glTexParameteri(GL12.GL_TEXTURE_3D, GL11.GL_TEXTURE_MIN_FILTER, filterMode);
                break;

            case TEXTURE_RECTANGLE:
                GL11.glTexImage2D(34037, 0, internalFormat.getId(), width, height, 0, pixelFormat.getId(), pixelType.getId(), (ByteBuffer)data);
                GL11.glTexParameteri(34037, GL11.GL_TEXTURE_WRAP_S, wrapMode);
                GL11.glTexParameteri(34037, GL11.GL_TEXTURE_WRAP_T, wrapMode);
                GL11.glTexParameteri(34037, GL11.GL_TEXTURE_MAG_FILTER, filterMode);
                GL11.glTexParameteri(34037, GL11.GL_TEXTURE_MIN_FILTER, filterMode);
        }
