...
public class ShaderUniforms
{
    ...
    {
        for (int uniformIndex = 0; uniformIndex < this.listUniforms.size(); ++uniformIndex)
        {
            ShaderUniformBase shaderUniformBase = (ShaderUniformBase)this.listUniforms.get(uniformIndex);
