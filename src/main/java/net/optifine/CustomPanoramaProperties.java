...
public class CustomPanoramaProperties
{
    ...
    public CustomPanoramaProperties(String path, Properties props)
    {
        ...
        for (int panoramaIndex = 0; panoramaIndex < this.panoramaLocations.length; ++panoramaIndex)
        {
            this.panoramaLocations[panoramaIndex] = new ResourceLocation(path + "/panorama_" + panoramaIndex + ".png");
        }
