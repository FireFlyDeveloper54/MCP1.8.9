...
public class CacheObjectArray
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        long longValue = testNewObj(i, j);
        long secondLongValue = testCloneObj(i, j);
        long thirdLongValue = testNewObjDyn(IBlockState.class, i, j);
        Config.dbg("New: " + k);
        Config.dbg("Clone: " + l);
        Config.dbg("NewObj: " + longValue);
        Config.dbg("CloneObj: " + secondLongValue);
        Config.dbg("NewObjDyn: " + thirdLongValue);
    }
