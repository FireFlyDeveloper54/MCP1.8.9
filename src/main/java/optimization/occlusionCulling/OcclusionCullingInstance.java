    ...
    private boolean isVisible(Vec3d start, Vec3d[] targets, int size) {
        ...
        for (int v = 0; v < size; v++) {
            ...
            if (dimensionX == 0f) {
                ...
                intersectCount += MathUtilities.fastFloor(target.x) - x;
                ...
                intersectCount += x - MathUtilities.fastFloor(target.x);
            ...
            if (dimensionY == 0f) {
                ...
                intersectCount += MathUtilities.fastFloor(target.y) - y;
                ...
                intersectCount += y - MathUtilities.fastFloor(target.y);
            ...
            if (dimensionZ == 0f) {
                ...
                intersectCount += MathUtilities.fastFloor(target.z) - z;
                ...
                intersectCount += z - MathUtilities.fastFloor(target.z);
